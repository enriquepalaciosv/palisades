const firstBundle = [
  ...
  },
  {
    ...
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-3-2.png",
        itemTitle: "1949. Opening Day",
        itemDescription:
          "On November 24, 1949, the first chair heads up the mountain, then the longest double chairlift in the world and two rope tows. Over the decades that follow, the mountain expands its terrain to include six peaks, spanning 3,600 skiable acres.The opening is a triumph for Cushing, but a painful loss to Poulsen, who was forced out of the company he helped start before the ski area ever opened. Poulsen retains operations of a small ski area and maintains ownership of much of the land in the valley, including the spectacular Olympic Meadow that he later helps to preserve from destruction.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-3-3.png",
        itemTitle: "1955. John Reily Eyes Alpine Meadows",
        itemDescription:
          "A Los Angeles businessman named John Reily visits the Tahoe area and looks southwest from the top of KT-22 to spot a pristine valley that he envisions as a neighboring ski area. With word of the Olympics coming to the valley, Reily envisions a promising future for the entire North Lake Tahoe region. On a day hike through the area, Sally Hudson, mother of future Olympian Bill Hudson, suggests the area should be named “Alpine Meadows.”",
      },
    ],
  },
  {
    defaultImage: "https://svamm-icros.vercel.app/assets/images/section-4.png",
    id: 4,
    year: 1960,
    title: "1960. Winter Olympic Games",
    description:
      "Cushing pulls off the triumph of a lifetime by convincing a very skeptical International Olympic Committee to select our mountain to host the first Winter Olympic Games in the western United States. The games are the first to be nationally televised, giving many people their first look at the exotic sport of skiing, and kicks off a wave of national interest in the sport. Inside the Olympic Village Lodge, athletes from every country dine together—the first and last time in Olympic history. Walt Disney leads the opening ceremonies, the sports of biathlon and women’s speed skating are introduced, and metal skis are used for the first time in ski racing. Computers are utilized for the first time to compute the scores, and the U.S. men’s ice hockey team beats the Russians in a major upset that’s been called the first miracle on ice.",
    caption: "",
    author: "",
  },
  {
    defaultImage: "https://svamm-icros.vercel.app/assets/images/section-5.png",
    id: 5,
    year: 1961,
    caption: "",
    author: "",
    ...
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-5-3.png",
        itemTitle: "1968. Aerial Tram Installed",
        itemDescription:
          "A cable car is shipped from Switzerland and constructed and installed at the Palisades base area. It whisks skiers 1.5 miles up a steep rock face to a mountaintop lodge called High Camp. Engineers looked at trams across Europe to consider the feasibility of designing one here. At the time, it was the largest aerial tramway in the world.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-5-4.png",
        itemTitle: "Late 1960s. Creating Champions",
        itemDescription:
          "A first-of-its-kind kids’ ski program called Mighty Mites is introduced, enabling youngsters starting at age five to join a youth ski development program. Since then, over 50 Mighty Mites have gone on to the U.S. Ski Team and at least 20 of them have competed in the Olympics. Athletes including Daron Rahlves, Julia Mancuso, C.R. Johnson, Cody Townsend, Travis Gangong, Amie Engerbretson, Michelle Parker, and JT Holmes got their start as Mighty Mites.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-5-5.png",
        itemTitle: "1970. Community of Writers at Squaw Valley",
        itemDescription:
          "Writers Oakley Hall and Blair Fuller start what is now the oldest writer’s conference on the west coast. Over the next 50 years, the conference becomes one of the most important in the U.S. Alumni include poet laureates of the United States as well as several individual states, numerous Pulitzer Prize and National Book Award winners, and active poets, screenwriters, novelists, and university faculty from around the world.",
      },
    ],
  },
  {
    defaultImage: "https://svamm-icros.vercel.app/assets/images/section-6.png",
    id: 6,
    year: 1975,
    title: "1975. Palisades Put On the Map",
    description:
      "Tahoe filmmaker Craig Beck debuts his film, Daydreams, shot on location at Palisades Tahoe. The movie is the first to capture high-stakes skiing off Palisades, the precipitous cliff band adjacent to the start of the 1960 men’s Olympic Downhill. In the film, Craig’s younger brother, Greg, airs over 100 feet to a stomped landing (on what is now known as Beck’s Rock) and Dave Burnham pulls off an 80-foot flip, giving the Palisades its modern-day mantra: “When it doubt, air it out.” By the early 80s, Warren Miller comes to Palisades Tahoe to film the likes of Scot Schmidt, Tom Day, Jim Zellers, and others, cementing mountain’s reputation as an extreme skier’s stomping grounds.",
    caption:
...
const secondBundle = [
  {
    ...
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-8-2.png",
        itemTitle: "1990. Cushing Crossing Pond Skimming",
        itemDescription:
          "One of the nation’s original pond skimming competitions, the inaugural Cushing Crossing, takes place at Palisades Tahoe. It sets in motion a spirited spring skiing tradition that lives on to this day.",
      },
    ],
  },
  {
    defaultImage: "https://svamm-icros.vercel.app/assets/images/section-9.png",
    id: 9,
    year: 1991,
    title: "1991. Jerry Garcia Band Plays",
    description:
      "Concert promoter Bill Graham teams up with the ski area to present the mountain’s Summer Music Festival. On the lineup: the Jerry Garcia Band, Béla Fleck and the Flecktones, David Grisman, and others. It’s the first of many major music festivals and acts to take the stage at the base of the legendary ski resort and a predecessor to events like the modern-day WinterWondergrass Festival.",
    caption: "Jerry Garcia Band concert at High Camp",
    author: "Tom Day",
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-9-2.png",
        itemTitle: "1998. Opening of the Gold Coast Funitel ",
        itemDescription:
          "North America’s only Funitel opens at Palisades, with each of its cabins carrying up to 28 passengers. Traveling at speeds up to 20 feet per second, the Funitel carries guests to the Gold Coast Lodge on the upper mountain in under eight minutes and can transport up to 4,000 people per hour.",
      },
    ],
  },
  {
    defaultImage: "https://svamm-icros.vercel.app/assets/images/section-10.png",
    id: 10,
    year: 1998,
    caption:
    ...
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-10.png",
        itemTitle: "1998. Jonny Moseley Wins Olympic Gold",
        itemDescription:
          "Jonny Moseley, who got his start as a young Mighty Mite at Palisades, wins gold in mogul skiing at the Nagano Winter Olympics with a groundbreaking 360 mute grab. Four years later, at the 2002 Olympics, Moseley lands a progressive new off-axis trick he invented, called the Dinner Roll, which changes the scope of freestyle skiing and is routinely done in mogul competitions to this day.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-10.png",
        ...
        itemDescription:
          "From Mighty Mites to pro skier, C.R. Johnson grew up on these slopes and was known for his progressive style and positive energy. At age 15, he becomes the first skier to land a 1440—four complete spins—a trick captured on film in Teton Gravity Research’s film Area 51. Johnson, beloved to this day, died in a tragic fall in 2010 at the age of 26.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-10.png",
        ...
        itemDescription:
          "After years of hucking himself off of the gnarliest cliffs Palisades has to offer, Shane McConkey lands a trifecta of acknowledgements: ESPN’s Action Sports Skier of the Year, first place in Red Bull’s Ultra Cross Big Air Comp, and Skiing Magazine’s #1 spot in the Top 25 skiers in North America. Forever progressing the sport through his wild skills and carefree spirit, Shane also finds time to invent the reverse camber and reverse sidecut ski, changing powder skiing forever. When he is tragically killed while BASE jumping in the Dolomites in 2009, an eagle sculpted from steel is bolted to the top of KT-22 to honor his memory and to inspire the ski pioneers of the future. Under the leadership of his wife, Sherry, the Shane McConkey Foundation continues to raise money for local schools and organizations, and the Pain McShlonkey Classic brings a celebratory vibe to the slopes each spring.",
      },
    ],
  },
];
...
const wideBundle = [
  {
    ...
    id: 11,
    year: 2002,
    title: "The Village at Palisades Tahoe",
    description:
      "Construction for the new base village on the Village at Palisades Tahoe side begins, with the addition of lodging, restaurants, and shops in the base area of the world-class ski resort.",
    caption:
    ...
    items: [
      ...
      },
      {
        ...
        itemDescription:
          "Extreme skier Robb Gaffney writes and publishes a book, Squallywood: A Guide to Squaw Valley’s Most Exposed Lines. The book brings attention to some of the flashier and lesser-known lines around the mountain, the steep chutes that have served as testing grounds for some of the most legendary big-mountain freeskiers and snowboarders, including Jeremy Jones, Shane McConkey, Michelle Parker, Jamie Burge, Kent Kreitler, Timy Dutton, CR Johnson, JT Holmes, Ingrid Backstrom, Cody Townsend, Elyse Saugstad, and more.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-11-4.png",
        itemTitle: "2006. Julia Mancuso Wins First Olympic Gold",
        itemDescription:
          "Growing up on the slopes of Palisades, ski racer Julia Mancuso joined the U.S. Ski Team as a teenager. By 2006, she wins her first Olympic gold in giant slalom at the Torino Winter Games. She goes on to become one of the most decorated American ski racers of all time, with four Olympic medals, five World Championship medals, and seven World Cup victories.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-11-5.png",
        itemTitle: "2006. Mike Wilson's Double Backflips",
        itemDescription:
          "Pro skier and big air specialist Mike Wilson throws consecutive double backflips off Beck’s Rock in the Palisades, 31 years after Greg Beck gave the rock its name (see: 1975). Wilson’s triumph is captured in Matchstick Productions’ movie The Push.",
      },
    ],
  },
  {
    ...
    description:
      "After many years of separate ownership, the Palisades and Alpine sides of the mountain join forces in November 2011. Together, the two ski areas offer skiers and riders access to over 6,000 acres on a single lift ticket and season pass and reignite John Reilly’s dreams of a lift connection between the two ski areas.",
  ...
  },
  {
    ...
    items: [
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-13-2.png",
        itemTitle: "2016. Backcountry Tours Out the Gates",
        itemDescription:
          "As a result of US Forest Service regulatory concerns,the mountain has always kept its backcountry gates closed, but starting in 2016, Alpenglow Expeditions, a permitted guide service, partners with the resorts to offer lift-accessed guided backcountry tours out the gates into, rarely-skied zones like National Geographic Bowl and Tram Ridge. The partnership later leads to the construction of the Tahoe Via, a via ferrata on the iconic Tram Face.",
      },
      {
        itemImage:
          "https://svamm-icros.vercel.app/assets/images/section-13-3.png",
        itemTitle: "2016. Spring Skiing Capital",
        itemDescription:
          "The mountain cements its status as Spring Skiing Capital: the official headquarters of spring skiing fun. The following year, at the end of a big winter, the inaugural Freedom Fest celebrates skiing and riding on the Fourth of July.",
      },
    ],
  },
];
