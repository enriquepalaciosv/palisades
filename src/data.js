const firstBundle = [
  {
    defaultImage:
      "https://svamm-icros.vercel.app/assets/images/section-1.png",
    id: 1,
    year: 0,
  ...
  {
    defaultImage:
      "https://svamm-icros.vercel.app/assets/images/section-2.png",
    id: 2,
    year: 1939,
  ...
  {
    defaultImage:
      "https://svamm-icros.vercel.app/assets/images/section-4.png",
    id: 4,
    year: 1960,
  ...
  {
    defaultImage:
      "https://svamm-icros.vercel.app/assets/images/section-5.png",
    id: 5,
    year: 1961,
    caption: "",
    author: "",
    ...
    items: [
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-5-3.png",
...
const firstWide = {
  ...
  items: [
    ...
    },
    {
      ...
      itemDescription:
        "Since the new sport of snowboarding still wasn’t allowed at ski resorts, Tahoe area snowboarders Mark Anolik, Bob Klein, Terry Kidwell, and others found a natural halfpipe alongside the town landfill in Tahoe City and created snowboarding’s first-ever halfpipe. Squaw Valley began permitting snowboarders during its night skiing sessions starting in 1986, making it one of the earlier resorts to allow the radical sport of snowboarding. (Alpine Meadows held out until 1997.) Snowboard film companies like Mack Dawg Productions and Standard Films eventually put Squaw Valley on the map in snowboarding circles.",
    },
  ],
};
...
const secondBundle = [
  {
    ...
    items: [
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-8-2.png",
        itemTitle: "1990. Cushing Crossing Pond Skimming",
        itemDescription:
          "The inaugural Cushing Crossing Pond Skimming event takes place at Squaw Valley as one of the nation’s original pond skimming competitions. It sets in motion a spirited, spring skiing tradition that lives on to this day.",
      },
    ],
  },
  {
    ...
    items: [
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-9-2.png",
        itemTitle: "1998. Opening of the Gold Coast Funitel ",
        itemDescription:
          "North America’s only Funitel opens at Squaw Valley, with each of its cabins carrying up to 28 passengers. Traveling at speeds up to 20 feet per second, the Funitel carries guests to the Gold Coast Lodge on the upper mountain in under eight minutes and can transport up to 4,000 people per hour.",
      },
    ],
  },
  {
...
const wideBundle = [
  {
    ...
    items: [
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-11-2.png",
      ...
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-11-3.png",
        itemTitle: "2003. Squallywood The Book Published",
        itemDescription:
          "Extreme skier Robb Gaffney writes and publishes a book, Squallywood: A Guide to Squaw Valley’s Most Exposed Lines. The book brings attention to some of the flashier and lesser-known lines around Squaw Valley, the steep chutes that have served as testing grounds for some of the most legendary big-mountain freeskiers and snowboarders, including Jeremy Jones, Shane McConkey, Michelle Parker, Jamie Burge, Kent Kreitler, Timy Dutton, CR Johnson, JT Holmes, Ingrid Backstrom, Cody Townsend, Elyse Saugstad, and more.",
      },
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-11-4.png",
        itemTitle: "2006. Julia Mancuso Wins First Olympic Gold",
        itemDescription:
          "Growing up on the slopes of Squaw Valley, ski racer Julia Mancuso joined the U.S. Ski Team as a teenager. By 2006, she wins her first Olympic gold in giant slalom at the Torino Winter Games. She goes on to become one of the most decorated American ski racers of all time, with four Olympic medals, five World Championship medals, and seven World Cup victories.",
      },
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-11-5.png",
  ...
  },
  {
    ...
    items: [
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-13-2.png",
        itemTitle: "2016. Backcountry Tours Out the Gates",
        itemDescription:
          "As a result of US Forest Service regulatory concerns, Squaw Valley has always kept its backcountry gates closed, but starting in 2016, Alpenglow Expeditions, a permitted guide service, partners with Squaw Valley Alpine Meadows to offer lift-accessed guided backcountry tours out the gates into Squaw Valley’s prized, rarely-skied zones like National Geographic Bowl and Tram Ridge. The partnership later leads to the construction of the Tahoe Via, a via ferrata on the iconic Tram Face.",
      },
      {
        itemImage: "https://svamm-icros.vercel.app/assets/images/section-13-3.png",
        itemTitle: "2016. Spring Skiing Capital",
        itemDescription:
          "Squaw Valley Alpine Meadows cements its status as Spring Skiing Capital: the official headquarters of spring skiing fun. The following year, at the end of a big winter, the inaugural Freedom Fest celebrates skiing at Squaw Valley on the Fourth of July.",
      },
    ],
  },
];
...
const lastWide = {
  ...
  items: [
    ...
    {
      itemImage: "https://svamm-icros.vercel.app/assets/images/section-15-4.png",
      itemTitle: "Squaw Valley Renamed Palisades Tahoe",
      itemDescription:
        "After many years of considering a name change due to the etymology and history of the term “squaw,” which is deemed a derogatory and offensive term to Native American women, the resort commences on a name changing initiative, which involves extensive community feedback and working with the local Washoe Tribe, and announces its new name: TK.",
    },
    {
      itemImage: "https://svamm-icros.vercel.app/assets/images/section-15-5.png",
