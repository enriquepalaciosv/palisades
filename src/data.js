...
const secondBundle = [
    ...
    },
    {
        ...
        description: "Concert promoter Bill Graham teams up with Squaw Valley to present the Squaw Valley Summer Music Festival. On the lineup: the Jerry Garcia Band, Béla Fleck and the Flecktones, David Grisman, and others. It's the first of many major music festivals and acts to take the stage at the base of the legendary ski resort and a predecessor to events like the modern-day WinterWondergrass Festival.",
        items: [
            { itemTitle: "1998. Opening of the Gold Coast Funitel ", itemDescription: "Lorem Ipsum" }
        ]
    },
    {
        id: 10,
        ...
        items: [
            {
                ...
                itemDescription: "Concert promoter Bill Graham teams up with Squaw Valley to present the Squaw Valley Summer Music Festival. On the lineup: the Jerry Garcia Band, Béla Fleck and the Flecktones, David Grisman, and others. It's the first of many major music festivals and acts to take the stage at the base of the legendary ski resort and a predecessor to events like the modern-day WinterWondergrass Festival."
            },
            {
